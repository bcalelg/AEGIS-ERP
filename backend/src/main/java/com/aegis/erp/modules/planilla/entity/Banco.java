...
@Entity @Table(name = "BANCO")
public class Banco extends AuditableEntity {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "ID_BANCO", nullable = false) private Long id;
    @Column(name = "NOMBRE", nullable = false, length = 50) private String nombre;
    protected Banco() {}
    public static Banco crear(String nombre,String usuario,java.time.LocalDateTime fecha){var e=new Banco();e.nombre=nombre;e.usuarioCreacion=usuario;e.fechaCreacion=fecha;return e;}
